...
2. **서비스 개발 배경** 
   * 문제 인식
     * 오프라인 서점 감소
     * 바쁜 일상 속에서 오프라인 서점을 방문할 시간이 부족하여 온라인으로 책을 구매하는 추세  <br>
3. **서비스 목표** 
   * 편리하고 효율적인 온라인 서점 플랫폼을 통해 사용자에게 최적의 독서 경험을 제공
...
![SpringBatch](https://img.shields.io/badge/SpringBatch-%236DB33F.svg?style=for-the-badge&logo=spring&logoColor=white) <br>
...
## 📊 ERD DIAGRAM
![ERD](https://github.com/user-attachments/assets/0a7e4a06-2b58-4bbf-af16-ef1da2a14fdf)
