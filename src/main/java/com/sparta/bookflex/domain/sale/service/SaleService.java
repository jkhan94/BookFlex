...
public class SaleService {
    ...
    public SaleService(SaleRepository saleRepository,
        ...
        public SaleVolumeResponseDto getSaleVoulmesByBookName ( int page, int size, boolean isAsc, String sortBy, String
        bookName, LocalDate startDate, LocalDate endDate){
        ...
        public SaleVolumeResponseDto getSaleVolumesByCategory ( int page, int size, boolean isAsc, String sortBy, String
        categoryName, LocalDate startDate, LocalDate endDate){
            Sort.Direction direction = isAsc ? Sort.Direction.ASC : Sort.Direction.DESC;
        ...
        public Page<SaleListDto> getAllSales ( int page, int size, boolean isAsc, String sortBy, String status, String
        username, LocalDate startDate, LocalDate endDate){
            Sort.Direction direction = isAsc ? Sort.Direction.ASC : Sort.Direction.DESC;
