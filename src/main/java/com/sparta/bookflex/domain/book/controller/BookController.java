...
public class BookController {
    ...
    @GetMapping()
    public CommonDto<List<BookResponseDto>> getBookByBookName(@RequestParam(name="bookName") String bookName) {

        List<BookResponseDto> bookResponseDto = bookService.getBooksByBookName(bookName);

        return new CommonDto<>(HttpStatus.OK.value(), "전체 상품 조회에 성공하였습니다.", bookResponseDto);
    }
